...
/**
 * @ClassName OAuth2UserDetailsManager
 * @Description TODO
 * @Author sky
 * @Date 2023/5/18 10:07
 * @Version 1.0
 **/
 ...
 */
@Slf4j
public class OAuth2UserDetailsManager extends JdbcDaoImpl implements UserDetailsService {
    ...
    public OAuth2UserDetailsManager(JdbcTemplate jdbcTemplate) {
